...
try {
	...
	$sql = "
		...
		INSERT INTO STATIONS   (ip, hash)                                                SELECT '192.168.1.100', HEX(SHA2(CONCAT(NOW(), RAND(), UUID()), 256));
		...
		INSERT INTO USBS       (uuid, brand, registration, emailEmployee)                VALUES ('3d03ea66-7c32-47c9-981c-556a12d76968', 'Kingston', '2019-04-20 07:45:23', 'mwalker@pr00filer.com');
		INSERT INTO USBS       (uuid, brand, registration, emailEmployee)                VALUES ('8adb083e-c46e-4e27-bb53-2bb6ee40deaa', 'SanDisk', '2019-09-07 13:12:42', 'alivingston@pr00filer.com');
		INSERT INTO USBS       (uuid, brand, registration, emailEmployee)                VALUES ('fd04587f-4477-463c-ba42-e388afda75f4', 'Patriot', '2020-06-18 17:24:13', 'sgray@pr00filer.com');
		INSERT INTO SCANS      (dateScan, duration, nbFiles, nbVirus, nbErrors, uuidUsb) VALUES ('2019-04-30 12:10:15', 23, 30, 0, 0, '3d03ea66-7c32-47c9-981c-556a12d76968');
		INSERT INTO SCANS      (dateScan, duration, nbFiles, nbVirus, nbErrors, uuidUsb) VALUES ('2019-09-07 14:28:53', 3, 1, 0, 0, '8adb083e-c46e-4e27-bb53-2bb6ee40deaa');
		INSERT INTO SCANS      (dateScan, duration, nbFiles, nbVirus, nbErrors, uuidUsb) VALUES ('2019-10-09 09:36:18', 7, 5, 1, 0, '3d03ea66-7c32-47c9-981c-556a12d76968');
		INSERT INTO SCANS      (dateScan, duration, nbFiles, nbVirus, nbErrors, uuidUsb) VALUES ('2019-10-09 18:17:35', 89, 74, 4, 1, '8adb083e-c46e-4e27-bb53-2bb6ee40deaa');
		INSERT INTO SCANS      (dateScan, duration, nbFiles, nbVirus, nbErrors, uuidUsb) VALUES ('2020-01-29 11:52:26', 376, 52, 0, 18, 'fd04587f-4477-463c-ba42-e388afda75f4');
		INSERT INTO SCANS      (dateScan, duration, nbFiles, nbVirus, nbErrors, uuidUsb) VALUES ('2020-03-14 11:49:45', 134, 18, 6, 4, '3d03ea66-7c32-47c9-981c-556a12d76968');
